...
@dataclass()
class RainbowRisingFit(BaseMultiBandFeature):
    """Multiband blackbody fit to the rising light curve.
    ...
    def _eval(self, *, t, m, sigma, band):
        ...
        return np.r_[[t0, amplitude, rise_time, T_min, delta_T, k_sig], baselines, reduced_chi2]
