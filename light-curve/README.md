...
You can run all benchmarks from the Python project folder with by `python3 -mpytest --benchmark-enable`, or with slow benchmarks disabled `python3 -mpytest -m "not nobs and multi" --benchmark-enable`.
